/**
 * Remote QR — shows a scannable QR code linking to the mobile remote page.
 * Fetches /api/config for the LAN IP, renders QR into a div.
 * Uses qrcodejs (inlined, MIT license) for reliable QR generation.
 */
...
<div class="sheet">
  ...
  <div class="sub">Scan with your phone to control playback</div>
  <div id="qr-container"></div>
  <div class="url" id="url"></div>
</div>
`;

class RemoteQR extends HTMLElement {
  constructor() {
    super();
  ...
  async _render() {
    try {
      ...
      // Prefer the user-saved WiFi IP (Crostini's lanIp is unreachable from phones)
...
customElements.define('remote-qr', RemoteQR);
